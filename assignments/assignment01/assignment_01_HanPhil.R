...
week1_sleep_weekdays <- week1_sleep[0:7]
...
total_sleep_week1 <-week1_sleep
total_sleep_week1
sum(total_sleep_week1)
...
total_sleep_week2 <- week2_sleep
total_sleep_week2
sum(total_sleep_week2)

## Determine if the total sleep in week 1 is less than week 2 by using the < operator
sum(total_sleep_week1) < sum(total_sleep_week2)
...
#weekdays <- c(6.1, 8.8, 7.7, 6.4, 6.2, 6.9, 6.6)
#week1_sleep <-weekdays
#mean(week1_sleep)
weekdays1_mean <-mean(week1_sleep)
weekdays1_mean <- mean(week1_sleep[0:7])
weekdays1_mean

weekdays2_mean <- mean(week2_sleep[weekdays])
weekdays2_mean <- mean(week2_sleep[0:7])
weekdays2_mean
